      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-1 lg:grid-cols-3">
          {TESTIMONIALS.map((testimonial, index) => (
            <div key={index} className="bg-gray-50 p-8 rounded-lg shadow-sm relative">
              <svg className="absolute top-6 left-6 h-8 w-8 text-indigo-100" fill="currentColor" viewBox="0 0 32 32">
              ...
              <p className="mt-8 text-gray-600 relative z-10">"{testimonial.quote}"</p>
